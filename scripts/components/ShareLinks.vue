<template>
  <div :class="classes">
    ...
    <a v-if="customSource" :href="customSource" target="_blank" class="share share--external">
      <img src="/assets/icon-link.svg" alt="Open" />
      <span v-html="formatedUrl"></span>
    </a>
  </div>
</template>
  ...
  export default {
    ...
    computed: {
      ...
      formatedUrl: function() {
        return getLocation(this.customSource).hostname
      }
    },
    methods: {
