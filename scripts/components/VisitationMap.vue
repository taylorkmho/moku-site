...
export default {
  ...
  methods: {
    ...
    addMarker: function(options) {
      ...
      const hasPopup =
        !!options.subtitle || !!options.description || !!options.logo
      let popup = null
      if (hasPopup) {
        let logo = ''
    ...
    setupMarkers: function() {
      ...
      this.addMarker({
        id: '133-nowelo',
        title:
          'Haleʻōlelo, Ka Haka ʻUla o Keʻelikōlani Hawaiian Language College',
